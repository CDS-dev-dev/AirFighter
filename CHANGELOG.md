...
- 全MAPの主役導線上に、制圧/探索ホットスポットを追加
- ホットスポット進捗を目的HUDとランドマークHUDへ表示
- ホットスポット到達時のスコア、補給、短いブースト報酬を追加

### Changed

- Dogfight / Total War ではホットスポット到達時に迎撃機が発生し、MAPの見せ場で戦闘が起きるよう改善
- 敵AIの理想位置にホットスポット周辺の立体位置取りを加え、戦闘を主役構造物へ寄せる力を強化
- Space のゾーンGLB/フォールバック構造物を `solid` として明示し、衝突対象の信頼性を改善
- 敵スポーン高度をMAPアンカー・ゾーン高度から決めるようにし、配置の平面化を軽減

### Notes

- 今回のリリースは、3Dアクションゲーム＋オープンワールドゲームとして「場所に意味がある」状態へ仕上げるための100点パス
...
- 全MAPの主役導線に、通過するとスコアと短いブースト報酬が入るルートゲートを追加
- Original / Tokyo / Space すべてにY方向を含む3D境界ボリュームを追加

### Changed

- 境界格子を「平面的な外周」ではなく、各MAPで実際に飛べる3D空間の限界として表示
- Tokyo の主役導線は閉じたループとして扱い、飛び続ける目的が生まれるよう改善
- MAPの導線表示を、単なる見た目からオープンワールド探索・空戦テンポに効くゲーム要素へ変更

### Notes

- 今回のリリースは、ゲーム全体を3Dアクション＋オープンワールドとして100点へ寄せるための追加実装パス
...
- Original MAP中央帯に、飛行回廊として使える巨大生物の背骨と肋骨を追加
- プレイヤーミサイルの位置を追いやすい控えめな追跡レティクルを追加
- ロック候補が前方コーン内にいない時のロック通知HUDを追加

### Changed

- ロックオン選定を全候補走査から前方コーン判定ベースへ統一
- 一度ロックした目標はその後にコーン外へ出ても維持される前提の挙動に整理
- プレイヤーミサイル発射時の追加ライト生成をやめ、発射時の軽い引っかかりを軽減
- Original MAPの巨大骨格を遮蔽物/弾道遮蔽として扱うように変更

### Notes

- 今回のリリースは、Original MAPの飛行体験強化と、ロックオン/ミサイル周りの戦闘感改善をまとめて反映

## [7.14.0] - 2026-06-13

### Changed

- 宇宙MAPの要塞をハブから少し引き、初期視界の圧迫を軽減
- ハブ近傍の大型導線フレーム生成を抑え、開始直後の空間の抜けを改善
- 導線演出が巨大な壁に見える要素を整理し、視界の読みやすさを向上

### Notes

- v7.13.0の宇宙MAP立体化を踏まえた仕上げリリース
- オープンワールド3Dアクションとして、開始直後の視界と導線理解を優先して最終調整

## [7.13.0] - 2026-06-13

### Changed

- 宇宙MAPの飛行可能Yレンジと境界格子Yレンジを統一
- 小惑星・デブリ・衛星などの空間分布を、薄い平面配置から立体ボリューム配置へ変更
- ハブから各ゾーンへの立体導線を追加し、要塞下降・採掘降下・軌道上昇・建造現場上昇の流れを明確化

### Added

- 宇宙船墓場の峡谷型残骸トンネル
- 要塞侵入ゲート、採掘コロニー下降シャフト、軌道リング上昇アーチ、建造現場フレーム導線
- 宇宙MAP再設計ドキュメント `docs/space-map-openworld-redesign.md`

### Notes

- 今回のリリースは、宇宙MAPを「平面的なオブジェクト配置」から「3Dアクション用の立体空間」へ寄せるための根本改善
- 視界整理と立体導線を優先しつつ、ハブ周辺の抜け感とゾーン間の高低差移動を強化
