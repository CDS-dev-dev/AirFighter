...
NEO TOKYO では人工的な空中レーンではなく、地形そのものの高低差で飛行体験を作る。西側の台地、都心の谷筋、隅田川沿いの低地、湾岸のくぼみを強調し、ランドマーク間を低空で抜けたり、台地の斜面に沿って旋回したりできる構造にする。
