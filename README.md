...
[![Version](https://img.shields.io/badge/version-7.13.0-blue.svg)](https://github.com/cds-dev-dev/AirFighter)
...
AirFighterは、Three.jsで作られた本格的な3D空中戦闘ゲームです。v7.13.0時点では、**v7.00.0で到達したBotW級の手作り感と探索価値**を土台に、ゲームプレイ演出とGLBベースの環境アセット移行に加え、宇宙MAPの立体導線再設計が進んでいます。
