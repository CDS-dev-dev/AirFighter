...
[![Version](https://img.shields.io/badge/version-7.14.0-blue.svg)](https://github.com/cds-dev-dev/AirFighter)
...
AirFighterは、Three.jsで作られた本格的な3D空中戦闘ゲームです。v7.14.0時点では、**v7.00.0で到達したBotW級の手作り感と探索価値**を土台に、ゲームプレイ演出とGLBベースの環境アセット移行に加え、宇宙MAPの立体導線と初期視界の再整理が進んでいます。
...
## 🚀 v7.14.0 現行リリース概要（2026-06-13）

### 現在の正式版について

このリポジトリの正式な現行バージョンは **v7.14.0** です。  
