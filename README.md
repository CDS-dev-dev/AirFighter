...
[![Version](https://img.shields.io/badge/version-7.00.0-blue.svg)](https://github.com/cds-dev-dev/AirFighter)
...
AirFighterは、Three.jsで作られた本格的な3D空中戦闘ゲームです。v7.00.0では**BotW（ゼルダの伝説 ブレス オブ ザ ワイルド）級の手作り感と探索価値**を実現しました。
